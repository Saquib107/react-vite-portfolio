...
const projects = [
  {
    ...
    tech: ['React', 'Vite', 'Tailwind CSS v4', 'Framer Motion', 'Canvas Confetti', 'Django'],
    accent: '#d4a373',
    image: decisionIqImg,
  ...
  },
  {
    ...
    tech: ['Next.js', 'Tailwind CSS v4', 'MongoDB', 'Mongoose', 'Framer Motion', 'Leaflet', 'MediaPipe', 'Razorpay', 'JWT Auth'],
    accent: '#f5e6d3',
    image: aiParkImg,
  ...
  },
  {
    ...
    tech: ['React', 'Vite', 'Tailwind CSS v4', 'GSAP', 'React Router v7', 'Radix UI'],
    accent: '#d4a373',
    image: glamBeautyImg,
